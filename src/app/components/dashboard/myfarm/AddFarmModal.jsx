          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <div className="space-y-2 text-sm">
                ...
                <p>
                  <span className="font-medium">আকার:</span> {formData.size} একর
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="bg-white p-4 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                  ...
                  <p>
                    <span className="font-medium">অবস্থান:</span>{" "}
                    {formData.location || "নির্ধারিত নয়"}
                  </p>
                  <p>
                    <span className="font-medium">আকার:</span>{" "}
                    {formData.size ? `${formData.size} একর` : "নির্ধারিত নয়"}
                  </p>
                </div>
              </div>
    ...
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          {currentStep === 2 && (
            <Step2Form formData={formData} onFieldChange={handleFieldChange} />
          )}
          {currentStep === 3 && (
            <Step3Form formData={formData} onFieldChange={handleFieldChange} />
          )}
          {currentStep === 4 && (
            <Step4Review
              formData={formData}
