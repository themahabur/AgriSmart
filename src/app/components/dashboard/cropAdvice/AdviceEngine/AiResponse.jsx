    ...
    <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl border border-green-200 p-6">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        <span className="px-3 py-1 inline-flex items-center bg-green-100 text-green-700 rounded-full text-sm">
          <BiCheck size={24} /> AI বিশ্লেষণ সম্পূর্ণ
        </span>
        <span className="px-3 inline-flex items-center gap-1 py-1 bg-blue-100 text-blue-700 rounded-full text-sm">
          <FaHistory /> ইতিহাসে সংরক্ষিত
        </span>
      </div>
    </div>
  );
