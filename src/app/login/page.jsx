...
অ্যাগ্রি স্মার্ট</h1>
            <p className="text-xl mb-8">
              রিয়েল-টাইম বাজার দর, আবহাওয়ার সতর্কতা এবং বিশেষজ্ঞ কৃষি পরামর্শ পান।
            </p>
      ...
      <div className="md:w-1/2 flex items-center justify-center p-8 bg-gradient-to-r from-green-50 to-amber-50">
        <div className="max-w-md w-full">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 mt-2">ফিরে আসার জন্য স্বাগতম! অনুগ্রহ করে আপনার তথ্য দিন।</p>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <p className="text-center text-sm text-gray-500 mb-4">অথবা চালিয়ে যান</p>
            <div className="">
              <button
                type="button"
